...
<?php include_once "navbar.php"; ?>
        ...
        <div class="col-md-6 product-details">
            <?php if ($producto): ?>
                ...
                <form method="post" action="../PHP/carrito.php" class="mt-4">
                    ...
                    <input type="hidden" name="imagen" value="<?php echo htmlspecialchars($producto['ImagenProducto']); ?>">
                    <div class="mb-3">
                        <label for="cantidad" class="form-label">Cantidad:</label>
                        <input type="number" name="cantidad" id="cantidad" class="form-control" value="1" min="1" max="10" style="width:100px;display:inline-block;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Talla:</label><br>
                        <?php foreach ($variantes as $variante): ?>
                            <input type="radio" name="talla" id="carrito-talla-<?php echo htmlspecialchars($variante['Talla']); ?>" value="<?php echo htmlspecialchars($variante['Talla']); ?>" required>
                            <label for="carrito-talla-<?php echo htmlspecialchars($variante['Talla']); ?>"> <?php echo htmlspecialchars($variante['Talla']); ?> </label>
                        <?php endforeach; ?>
                    </div>
                    <button type="submit" class="btn btn-success w-100"><i class="fas fa-cart-plus"></i> Agregar al carrito</button>
                </form>
